...
>
    <div x-data="tabelaApp()" class="min-h-screen">
        ...
        <main class="main-container">
            ...
            {{-- Imagem Visão --}}
            <div class="visao-section" @click="openFloorPlan('/images/visao.png', 'Visão do Empreendimento')">
                <img src="/images/visao.png" alt="Visão do Empreendimento" class="visao-image">
                <div class="visao-overlay">
